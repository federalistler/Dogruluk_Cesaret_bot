...
def button():
	BUTTON=[[InlineKeyboardButton(text="Support ",url="t.me/+DoMHxUEX3TUwMjlk")]]
	BUTTON+=[[InlineKeyboardButton(text="Sahibim",url="t.me/merdocann")]]
